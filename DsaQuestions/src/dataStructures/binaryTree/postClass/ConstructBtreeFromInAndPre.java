...
public class ConstructBtreeFromInAndPre {
    ...
    TreeNode buildtree(int[] inorder, int[] preorder, int inStart, int inEnd, int preStart, int preEnd,
    ...
    TreeNode buildTree(int[] inorder, int[] postorder, int inStart, int inEnd, int postStart, int postEnd,
        ...
        root.left = buildTree(inorder, postorder, inStart, inRoot - 1, postStart, postStart + (inRoot - inStart) - 1,
                hm);
